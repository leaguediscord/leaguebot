...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    let embedRunes = {
      title: `Runes ${args[0]}`,
      description: `Primary: (${response.runes.primary[0]})\n[ ][ ][X][ ] ${response.runes.primary[1]}\n1 [ ][X][ ] ${response.runes.primary[2]}\n2 [X][ ][ ] ${response.runes.primary[3]}\n3 [X][ ][ ] ${response.runes.primary[4]}\n\nSecondary: (${response.runes.secondary[0]})\n1 [ ][X][ ] ${response.runes.secondary[1]}\n2 [ ][X][ ] ${response.runes.secondary[2]}\n\nAdditional:\n[X][ ][ ] ${response.runes.additional[0]}\n[X][ ][ ] ${response.runes.additional[1]}\n[ ][X][ ] ${response.runes.additional[2]}`,
      color: 0x008000
    }
